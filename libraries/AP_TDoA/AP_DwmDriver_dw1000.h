...
#define SPEED_OF_LIGHT_IN_VOID 299792458.0

//refractive index of air = 1.0003 at 0°C and atmosferic pressure
//refractive index of air = 1 + 0.000293 * P/P0 * T0/T
//where P0 is atmospheric pressure, T0 is 300°K  (26.85°C)
//typical temp are in the  273° - 310° K range
#define AVERAGE_TEMPERATURE 288.71 // °K  (15.6 °C)  standard temp, temperature sensor could be used
#define REFRACTIVE_INDEX_OF_AIR (300.0 / AVERAGE_TEMPERATURE * .000293 + 1)
#define SPEED_OF_LIGHT_IN_AIR (SPEED_OF_LIGHT_IN_VOID / REFRACTIVE_INDEX_OF_AIR)

// Timestamp counter frequency
#define DWM1000_TS_FREQ (499.2e6 * 128)  // 63897600000.0

// Speed of radio waves [m/s] * timestamp resolution [~15.65ps] of DW1000
// in the void:
//       0.00469176397861578525641025641026
//     213.139451293334404029603706708
// in the air:
//       0.0046903359694310912952897041350297513417899608612060546875
//     213.204343253324310580865130759775638580322265625
#define SPEED_OF_LIGHT_ON_COUNTER_FREQ  (SPEED_OF_LIGHT_IN_AIR / DWM1000_TS_FREQ)
#define SPEED_OF_LIGHT_ON_COUNTER_FREQ_INV  (1 / SPEED_OF_LIGHT_ON_COUNTER_FREQ)
